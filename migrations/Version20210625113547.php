 ...
 */
final class Version20210625113547 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__quack AS SELECT id, duck_id, content, created_at, picture FROM quack');
        ...
        , picture VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_83D44F6F12CF4A47 FOREIGN KEY (duck_id) REFERENCES duck (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO quack (id, duck_id, content, created_at, picture) SELECT id, duck_id, content, created_at, picture FROM __temp__quack');
